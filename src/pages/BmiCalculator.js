    ...
    return (
        <div>
            <Stack p="80px" gap="30px" backgroundColor="#fff3f4" width="90%" margin="auto" mt="100px" >
                <Typography variant="h3">Calculate Your BMI </Typography>
                ...
                <Button variant="contained" color="success" onClick={fetchBMICalData} disabled={loading}>Calculate BMI</Button>
            </Stack>
            {BMI === "Not Calcualted" ? '' :
                <Stack p="80px" gap="30px" backgroundColor="#fff3f4" width="90%" margin="auto" mt="100px">
